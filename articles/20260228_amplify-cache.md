...
CloudFront キャッシュポリシーのTTL設定がCloudFrontがOriginからキャッシュする期間の設定です

![4.png](/images/20260228_amplify-cache/4.png)

@[card](https://docs.aws.amazon.com/ja_jp/AmazonCloudFront/latest/DeveloperGuide/cache-key-understand-cache-policy.html)
